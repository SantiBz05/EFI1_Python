...
def categorias_inactivas():
    ...
    return render_template(
        "list_categorias_inactivas.html", categorias=categorias_inactivas
    )
...
def fabricantes_inactivos():
    ...
    return render_template(
        "list_fabricantes_inactivos.html", fabricantes=fabricantes_inactivos
    )
...
def accesorios_inactivos():
    ...
    return render_template(
        "list_accesorios_inactivos.html", accesorios=accesorios_inactivos
    )
...
def proveedores():
    ...
    if request.method == "POST":
        ...
        nuevoProveedor = Proveedor(nombre=nombre, contacto=contacto)
...
def proveedores_inactivos():
    ...
    return render_template(
        "list_proveedores_inactivos.html", proveedores=proveedores_inactivos
    )
...
def inventarios_inactivos():
    ...
    return render_template(
        "list_inventarios_inactivos.html", inventarios=inventarios_inactivos
    )
...
def añadirCaracteristica():
    ...
    return render_template(
        "list_caracteristicas.html", añadirCaracteristica=añadirCaracteristica
    )
...
def caracteristicas_inactivas():
    ...
    return render_template(
        "list_caracteristicas_inactivas.html", caracteristicas=caracteristicas_inactivas
    )
...
def pedido_editar(id):
    ...
    return render_template("editar_pedido.html", pedido=pedido, proveedores=proveedores)
...
def empleados_inactivos():
    ...
    return render_template(
        "list_empleados_inactivos.html", empleados=empleados_inactivos
    )
...
def empleado_editar(id):
    ...
    return render_template(
        "editar_empleado.html", empleado=empleado, sucursales=sucursales
    )
...
def sucursales_inactivas():
    ...
    return render_template(
        "list_sucursales_inactivas.html", sucursales=sucursales_inactivas
    )
